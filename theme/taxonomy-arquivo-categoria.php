        ...
        <main class="content-page" role="main">
            ...
            <div class="content-page-item">
                <article id="post-<?php the_ID(); ?>" class="article article-full">
                    <header>
                        <?php $term = get_term_by( 'slug', get_query_var( 'term' ), 'arquivo-categoria' ); ?>
                        <h1 class="article-title">Biblioteca - Categoria "<?php echo $term->name ?>"</h1>
...
<?php
$termchildren = get_term_children( $term->term_id, 'arquivo-categoria' );
